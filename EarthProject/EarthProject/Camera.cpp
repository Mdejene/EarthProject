...
void Camera::setLens(float fovY, float aspect, float zn, float zf)
{
	...
	D3DXMatrixOrthoLH(&mOrtho, (float)800, (float)600, 0.0f, 1000);
}
...
void Camera::rebuildView()
{
	...
	if(StaticCamera)
	D3DXMatrixLookAtLH(&mView, &D3DXVECTOR3(0, 0, 1000), &D3DXVECTOR3(0, 0, 0), &D3DXVECTOR3(0,1, 0));
	else
	{
	mView(0,0) = mRight.x; 
	mView(1,0) = mRight.y; 
